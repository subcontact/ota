/*** Generated by streamline 0.10.4 (generators) - DO NOT EDIT ***/var galaxy = require("streamline/lib/generators/runtime"); (galaxy.unstar(function*(_) {var getFolders_ = galaxy.unstar(getFolders, 2), getFiles_ = galaxy.unstar(getFiles, 2), getBuildProjects_ = galaxy.unstar(getBuildProjects, 1), getBuildProjectList_ = galaxy.unstar(getBuildProjectList, 1), getProjectsService_ = galaxy.unstar(getProjectsService, 2), getProjectBuildListService_ = galaxy.unstar(getProjectBuildListService, 1), getProjectBuildDataService_ = galaxy.unstar(getProjectBuildDataService, 1), main_ = galaxy.unstar(main, 0); 
"use strict";
